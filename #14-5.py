...
def savetxt():
    ...
    if var != "":
        ...
        with open(path + ".txt", 'w') as f:
            f.write("Ответ" + str(entry_1.get()) + " = " + str(label_3.cget("text")))
            f.close()
    else:
        pass
...
button_2 = Button(text="Сохранить в .txt", width=15, command=lambda: savetxt())
button_2.grid(row=4, column=0, columnspan=1, pady=10, padx=10)

button_3 = Button(text="Сохранить в .html", width=15, command=lambda: savehtml())
